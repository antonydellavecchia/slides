...
\begin{frame}[fragile]{Algebraic Shifting}
  ...
  \begin{theorem}[Kalai, Bjoner-Kalai]
...
\begin{frame}[fragile]{Algebraic Exterior Shifting}
    Let $\EE \supset \FF$ be a field extension, for $g \in \GL(\EE, n)$ 
    the $k$th \emph{compound matrix} $g^{\wedge k}$ is the $\binom{n}{k} \times \binom{n}{k}$-matrix
    of $k$-minors of $g$.
