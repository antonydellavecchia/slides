...
\begin{frame}[fragile]{Term Order and Gr\"obner basis}
  ...
  \end{defn}
  \begin{Lemma}
    Given a term order $\succ$ a set $G \subset \mathcal{L}_{\succ}$ is a $\succ$-Gr\"obner basis of $\mathcal{L}$ if and only if for all $v \in \mathcal{L}_{\succ}$ there exists $u \in \mathcal{L}_{\succ}$ such that $u^+ \leq v^+$, that is, $v^+ - u \in \mathcal{F}_{\mathcal{L}, v^+}$ and $v^+ \succ v^+ - u$.
  \end{Lemma}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
