...
\begin{frame}[fragile]{The \texttt{mrdi} File Format}
  \begin{tcolorbox}[]
    ...
    \item References stored with UUIDs handle the isomorphism problem.
    \end{itemize}
  \end{tcolorbox}
\end{frame}
...
\begin{frame}{Implementation Details}
  ...
  \item Type registration, used for security, type stringification and declaring which types need ids (refs).
  ...
  \item Global Serializer state for persitences across many files.
  \end{itemize}
\end{frame}
