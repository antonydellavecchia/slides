...
\newcommand{\pmsmall}{\includegraphics[scale=0.03]{images/pmlogo.png}}
\newcommand{\pmlogo}{\includegraphics[scale=0.09]{images/pmlogo.png}}
...
\begin{frame}[fragile]{MaRDI and the FAIR principles}
  ...
  \item \textbf{F}indable \textpbf{A}ccessible \textbf{I}nteroperable \textbf{R}eusable [M. D. Wilkinson et al. 2016]
...
\begin{frame}[fragile]{Benefits of Julia}
  \begin{tabular}{cl}  
    \begin{tabular}{c}
      \begin{figure}
        \begin{minipage}{0.4\textwidth}
